...
class _WorldState extends State<World> {
 ...
 Future showcard (String cases,newdeaths,recovered,deaths,newcases,newrecoveries,active) async
  {
     await showDialog(
        context: context,
            ...
            content: SingleChildScrollView(
              child: ListBody(
                children: <Widget>[
                    ...
                    Text("Total Recoveries :$recovered",style: TextStyle(fontSize: 25,color : Colors.green),),
                    Text("New Cases :$newcases",style: TextStyle(fontSize: 25,color : Colors.white)),
                    Text("Today's Deaths :$newdeaths",style: TextStyle(fontSize: 25,color : Colors.red)),
                    Text("Today's Recoveries :$newrecoveries",style: TextStyle(fontSize: 25,color : Colors.green)),
                    Text("Active Cases :$active",style: TextStyle(fontSize: 25,color : Colors.yellow),),
